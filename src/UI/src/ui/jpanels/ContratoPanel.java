 ...
 * @author pc8
 */
public class ContratoPanel extends javax.swing.JPanel {
    ...
    private void llenarTabla(){
        limpiarTabla();
        lista = ContratoService.getAllContratos();
        for (ContratoTable cont : lista) {
            tableModel.agregarComp(cont.contratoId(), cont.proveedorName(), Util.formatFecha(cont.fechaInicio()), Util.formatFecha(cont.fechaFin()), Util.formatFecha(cont.fechaConciliacion()), cont.descripcion());
        }
    }
        ...
        if (contTable.getSelectedRow() != -1){
            try {
                ...
                if (respuesta == JOptionPane.YES_OPTION){
                    ContratoTable cont = lista.get(contTable.getSelectedRow());
