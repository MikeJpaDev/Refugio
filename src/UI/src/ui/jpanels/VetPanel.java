...
import ui.jdialogs.VerVet;
import ui.utils.VetTableModel;
 ...
 * @author pc8
 */
public class VetPanel extends javax.swing.JPanel {
    private static VetTableModel tableModel;
        ...
        if (vetTable.getSelectedRow() != -1)
         java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                VerVet dialog = new VerVet(mainFrame, true, lista.get(vetTable.getSelectedRow()));
    ...
    private void ModificarBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ModificarBtnActionPerformed
        Reports.generarReportePDF("/reports/RepVetV2.jasper");
        ...
        if (vetTable.getSelectedRow() != -1){
            try {
                ...
                if (respuesta == JOptionPane.YES_OPTION){
                    Veterinario vet = lista.get(vetTable.getSelectedRow());
                    ProveedorService.deleteProveedor(vet.proveedor_id());
