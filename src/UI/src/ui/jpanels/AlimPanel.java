 ...
 * @author pc8
 */
public class AlimPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        alimTable = new javax.swing.JTable();
        ...
        alimTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(alimTable);
        ...
        if (alimTable.getSelectedRow() != -1){
            try {
                ...
                if (respuesta == JOptionPane.YES_OPTION){
                    ProveedorAlimento alim = lista.get(alimTable.getSelectedRow());
                    ProveedorService.deleteProveedor(alim.proveedor_id());
    ...
    private void llenarTabla(){
        limpiarTabla();
        lista = ProvAlimentoService.getAllAlimentos();
        for (ProveedorAlimento alimento: lista) {
            tableModel.agregarAlim(alimento.proveedor_id(), alimento.nombre_proveedor(), alimento.provincia(), alimento.tipo_alimento(), alimento.responsable());
        }
    }
