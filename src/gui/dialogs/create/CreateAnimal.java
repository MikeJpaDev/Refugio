 ...
 */
public class CreateAnimal extends javax.swing.JDialog {

    /**
     * Creates new form CreateAnimal
     */
    public CreateAnimal(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Crear Registro de Animal");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CreateAnimal dialog = new CreateAnimal(new javax.swing.JFrame(), true);
